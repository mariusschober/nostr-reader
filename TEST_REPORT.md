...
| Chrome unit/fault | Vitest 5.0 | `npm test` | all pass | 16 files, 95 tests pass | `pairing-relay-state-hardening-2026-09-05.txt` | PASS |
...
| Chrome persistence | paired CFT profile | reload/restart + status + relay-digest integrity | pairing/outbox survive with exact bound state | paired, exact seven relays, digest present/matched, delivered 1, pending 0 | `chrome-paired-status-*`, `pairing-relay-state-hardening-*` | PASS |
