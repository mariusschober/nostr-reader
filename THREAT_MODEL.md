...
| replay/duplicate | duplicate document or stale trust promotion | expiry, one-shot session binding, event/run dedupe, persistent document ID, exact transfer identity | unit/instrumentation/live duplicate observation | duplicate ACK batch can recur across later catch-up runs |
