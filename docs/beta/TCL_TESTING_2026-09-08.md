...
Handle extension/reversal, Unicode and multiline share receipt, review gestures and lifecycle restoration, themes and accessibility, large-part rendering performance, TTS and lifecycle behavior, packaged Chrome permission/provider acceptance, and final exact-candidate delivery/fault campaigns remain open. No final release or reliability acceptance is claimed. The main app and paired owner profile must retain their data and keys; destructive fault injection belongs in the isolated QA app/profile. Reconnect the TCL to resume the pending physical cases.
